...
| `feature/sim-music/audio-lift-and-render` | `crate/sim-lib-sound-audio-lift` | [features/feature--sim-music--audio-lift-and-render.md](../index/features/feature--sim-music--audio-lift-and-render.md) | 5 | Lift PCM through bounded YIN/pYIN and polyphonic partial tracks, reconstructable framed Fourier analysis, tuning-anchored constant-Q and chroma profiles, spectral summaries, and finite sound or stream rendering. |
