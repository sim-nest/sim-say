...
| `feature/sim-numbers/tensors` | `local/sim-numbers/crate/sim-lib-numbers-tensor` | [features/feature--sim-numbers--tensors.md](../index/features/feature--sim-numbers--tensors.md) | 1 | Provide the canonical runtime Tensor value, typed tensor descriptors, broadcasting, and matrix operations. |
