...
| `feature/sim-femm/linear-solvers` | `crate/sim-lib-femm-solve` | [features/feature--sim-femm--linear-solvers.md](../index/features/feature--sim-femm--linear-solvers.md) | 1 | Provide FEMM linear solver contracts, factor handles, dense fallback, iterative CG and BiCGSTAB kernels, and solve certificates. |
