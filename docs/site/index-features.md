...
| `feature/sim-music/audio-lift-and-render` | `crate/sim-lib-sound-audio-lift` | [features/feature--sim-music--audio-lift-and-render.md](../index/features/feature--sim-music--audio-lift-and-render.md) | 2 | Lift PCM through reconstructable framed Fourier analysis, bounded tuning-anchored constant-Q and chroma profiles, pitch candidates, spectral summaries, and finite sound or stream rendering. |
