...
| `feature/sim-discrete/discrete-algebra` | `local/sim-discrete/crate/sim-lib-discrete` | [features/feature--sim-discrete--discrete-algebra.md](../index/features/feature--sim-discrete--discrete-algebra.md) | 2 | Provide algebra, certified minimum-cost assignment and graph paths, combinatorics, ranking, and spectral helpers as one reusable discrete-domain stack. |
