...
| `feature/sim-index/core` | `local/sim-tooling/crate/xtask` | [features/feature--sim-index--core.md](../index/features/feature--sim-index--core.md) | 1 | Generate, query, route, prove, and check duplicate implementation overlap in the SIM Index graph as a checked constellation surface. |
