...
| `feature/sim-construction/project-control` | `crate/sim-lib-construction-project` | [features/feature--sim-construction--project-control.md](../index/features/feature--sim-construction--project-control.md) | 3 | Describe construction as-of snapshot records, project charter identity, append-only fact books, deterministic deltas, governance, capabilities, and readiness with reference-only evidence. |
