...
| `feature/sim-expr-tree/incremental-calculation` | `crate/sim-expr-tree-calc` | [features/feature--sim-expr-tree--incremental-calculation.md](../index/features/feature--sim-expr-tree--incremental-calculation.md) | 1 | Record dynamic expression-tree references and structural dependencies from runtime evaluation over the generic incremental query engine. |
| `feature/sim-expr-tree/mixed-backend-storage` | `crate/sim-expr-tree-core` | [features/feature--sim-expr-tree--mixed-backend-storage.md](../index/features/feature--sim-expr-tree--mixed-backend-storage.md) | 1 | Compose authored source, operational control, rebuildable derived state, and explicit Table/Dir mounts without flattening mounted backend behavior. |
