...
| `feature/sim-music/music-counterpoint` | `crate/sim-lib-music-counterpoint` | [features/feature--sim-music--music-counterpoint.md](../index/features/feature--sim-music--music-counterpoint.md) | 1 | Analyze existing voices under inspectable species or open rules and derive bounded stretto couples, compatibility graphs, maximal cliques, clusters, chains, fusions, and transform candidates. |
