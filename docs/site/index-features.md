...
| `feature/sim-office/document-codecs` | `crate/sim-lib-office-pack` | [features/feature--sim-office--document-codecs.md](../index/features/feature--sim-office--document-codecs.md) | 1 | Round-trip OOXML, ODF, MSPDI, deck, sheet, and markup documents through office codec recipes. |
