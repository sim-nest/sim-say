...
| `feature/sim-music/twelve-tone-row-theory` | `crate/sim-lib-pitch-serial` | [features/feature--sim-music--twelve-tone-row-theory.md](../index/features/feature--sim-music--twelve-tone-row-theory.md) | 1 | Validate canonical twelve-pitch rows, apply total P/I/R/RI operations, and project operation-bearing forms through an explicit label convention. |
