...
| `feature/sim-numbers/numbers` | `crate/sim-lib-numbers-core` | [features/feature--sim-numbers--numbers.md](../index/features/feature--sim-numbers--numbers.md) | 2 | Provide arithmetic, exact, floating, symbolic, tensor, signal-transform, and inspectable statistics domains as loadable libraries. |
...
| `feature/sim-numbers/signal-transforms` | `crate/sim-lib-numbers-signal` | [features/feature--sim-numbers--signal-transforms.md](../index/features/feature--sim-numbers--signal-transforms.md) | 2 | Transform canonical complex and f64 tensor signals with direct definitions, fast paths, strided multidimensional views, and bounded Table/Dir block plans. |
