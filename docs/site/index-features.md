...
| `feature/sim-discrete/discrete-algebra` | `local/sim-discrete/crate/sim-lib-discrete` | [features/feature--sim-discrete--discrete-algebra.md](../index/features/feature--sim-discrete--discrete-algebra.md) | 4 | Provide algebra, certified rectangular assignment, graph and staged paths, sequence alignment, combinatorics, ranking, and spectral helpers as one reusable discrete-domain stack. |
...
| `feature/sim-music/audio-lift-and-render` | `crate/sim-lib-sound-audio-lift` | [features/feature--sim-music--audio-lift-and-render.md](../index/features/feature--sim-music--audio-lift-and-render.md) | 1 | Lift PCM audio into sound features, reuse spectral summaries, and render finite sound buffers or WAV/SMF stream files through current sound libraries. |
...
| `feature/sim-music/exact-music-analysis-and-transform` | `crate/sim-lib-music-analysis` | [features/feature--sim-music--exact-music-analysis-and-transform.md](../index/features/feature--sim-music--exact-music-analysis-and-transform.md) | 4 | Convert exact score forms with loss and identity evidence, find certified voice-leading paths, and transform exact progressions with audited articulation, register, rhythm, and pitch operations. |
...
| `feature/sim-music/sound-spectrum-adapter` | `crate/sim-lib-sound-spectrum` | [features/feature--sim-music--sound-spectrum-adapter.md](../index/features/feature--sim-music--sound-spectrum-adapter.md) | 1 | Retain physical frequency, amplitude, provenance, and sound descriptors while delegating PCM transform math to the generic numbers-signal real FFT. |
...
| `feature/sim-numbers/statistical-inference` | `crate/sim-lib-numbers-stats` | [features/feature--sim-numbers--statistical-inference.md](../index/features/feature--sim-numbers--statistical-inference.md) | 3 | Estimate mergeable streaming quantiles and infer finite hidden-state sequences with explicit numerical, convergence, memory, and termination evidence. |
