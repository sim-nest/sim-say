...
| `feature/sim-agent-net/genai-assembly` | `local/sim-agent-net/crate/sim-lib-agent` | [features/feature--sim-agent-net--genai-assembly.md](../index/features/feature--sim-agent-net--genai-assembly.md) | 2 | Compose one checked generative exchange from BRIDGE packets, model placement, JSON terminal content, and a return Shape. |
