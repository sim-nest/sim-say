...
| `feature/sim-music/exact-music-analysis-and-transform` | `crate/sim-lib-music-analysis` | [features/feature--sim-music--exact-music-analysis-and-transform.md](../index/features/feature--sim-music--exact-music-analysis-and-transform.md) | 5 | Convert exact score forms with loss and identity evidence, decode key/chord feature sequences with posterior alternatives, find certified voice-leading and Tonnetz paths, and transform exact progressions with audited operations. |
