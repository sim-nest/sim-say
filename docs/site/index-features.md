...
| `feature/sim-numbers/signal-transforms` | `crate/sim-lib-numbers-signal` | [features/feature--sim-numbers--signal-transforms.md](../index/features/feature--sim-numbers--signal-transforms.md) | 4 | Transform, convolve, correlate, and guardedly deconvolve canonical tensor signals with direct definitions, FFT paths, explicit conventions, and bounded block reports. |
