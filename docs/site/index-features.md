...
| `feature/sim-numbers/signal-transforms` | `crate/sim-lib-numbers-signal` | [features/feature--sim-numbers--signal-transforms.md](../index/features/feature--sim-numbers--signal-transforms.md) | 1 | Transform canonical complex and f64 tensor signals with direct DFT definitions, mixed-radix and Bluestein FFTs, real packing, and DCT/DST I-IV. |
