...
| `feature/sim-music/pitch-and-sound-vocabulary` | `crate/sim-lib-pitch-core` | [features/feature--sim-music--pitch-and-sound-vocabulary.md](../index/features/feature--sim-music--pitch-and-sound-vocabulary.md) | 1 | Name chords, scales, pitch sets, pitch-set graph walks, timbres, spectra, and tuning facts through worked musical descriptors and bounded timbre families. |
