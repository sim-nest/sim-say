...
| `feature/sim-numbers/signal-transforms` | `crate/sim-lib-numbers-signal` | [features/feature--sim-numbers--signal-transforms.md](../index/features/feature--sim-numbers--signal-transforms.md) | 5 | Transform, convolve, correlate, estimate classical spectra, and guardedly deconvolve signals with reference definitions, explicit scaling, and bounded reports. |
