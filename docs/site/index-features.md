...
| `feature/sim-numbers/signal-transforms` | `crate/sim-lib-numbers-signal` | [features/feature--sim-numbers--signal-transforms.md](../index/features/feature--sim-numbers--signal-transforms.md) | 8 | Transform, convolve, correlate, fit stable autoregressive models, estimate classical or MEM spectra, interpolate periodic DFT series, derive analytic signals, and guardedly deconvolve with explicit bounded reports. |
