# Role-safe artifact facet law

<!-- GENERATED BY xtask index render; DO NOT EDIT. -->

- Feature id: `feature/sim-storage/artifact-facet-law`
- Subject: `crate/sim-artifact-facet`
- Canonical key: `crate/sim-artifact-facet/feature-sim-storage-artifact-facet-law`

Classify and merge exact base, observed, and intended artifact images under singular owner, region, generated-owner, disclosure, and bounded merge declarations.

## Anchors

- `anchor/crate/sim-artifact-facet`

## Specimens

- `spec-test/sim-storage/crates/sim-artifact-facet/tests/facet_law`
