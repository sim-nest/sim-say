# Scope-exact neutral conformance packs

<!-- GENERATED BY xtask index render; DO NOT EDIT. -->

- Feature id: `feature/sim-sdk/neutral-conformance-packs`
- Subject: `crate/sim-conformance-packs`
- Canonical key: `crate/sim-conformance-packs/feature-sim-sdk-neutral-conformance-packs`

Expose all 21 checker entrypoints with pure evidence-driven scenarios, canonical results, and typed unavailable outcomes for scopes whose funded phase has not shipped, including canonical native-journal identity, compatibility, replay performance, and causal sharing.
...
Specimen `spec-test/sim-sdk/crates/sim-conformance-packs/tests/bootstrap_packs` is checked by `cargo test`.

Source `crates/sim-conformance-packs/tests/bootstrap_packs.rs`:
