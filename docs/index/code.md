...
| `local/sim-platform/crate/sim-viture-ffi` | `crate` | sim-viture-ffi | 0 |
...
| `local/sim-stream-host/crate/sim-viture-ffi` | `crate` | sim-viture-ffi | 0 |
