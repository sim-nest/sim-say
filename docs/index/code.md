...
| `crate/boundary-event` | `crate` | boundary-event | 0 |
| `crate/citizen-roundtrip` | `crate` | citizen-roundtrip | 0 |
| `crate/music-algorithm-foundry` | `crate` | music-algorithm-foundry | 1 |
| `crate/physics-certified-refinement-recipe` | `crate` | physics-certified-refinement-recipe | 0 |
| `crate/physics-placement-sweep-recipe` | `crate` | physics-placement-sweep-recipe | 0 |
| `crate/physics-refused-selection-recipe` | `crate` | physics-refused-selection-recipe | 0 |
| `crate/physics-stored-energy-recipe` | `crate` | physics-stored-energy-recipe | 0 |
...
| `crate/sim-codec-feed` | `crate` | sim-codec-feed | 0 |
| `crate/sim-codec-index` | `crate` | sim-codec-index | 1 |
| `crate/sim-codec-index-vault` | `crate` | sim-codec-index-vault | 0 |
...
| `crate/sim-codec-robots` | `crate` | sim-codec-robots | 0 |
| `crate/sim-codec-search-searxng` | `crate` | sim-codec-search-searxng | 0 |
| `crate/sim-codec-sql` | `crate` | sim-codec-sql | 0 |
...
| `crate/sim-ledger-store-port` | `crate` | sim-ledger-store-port | 0 |
| `crate/sim-ledger-test-support` | `crate` | sim-ledger-test-support | 0 |
| `crate/sim-lib-agent-conduct` | `crate` | sim-lib-agent-conduct | 0 |
| `crate/sim-lib-agent-conduct-core-recipe-pure-journal` | `crate` | sim-lib-agent-conduct-core-recipe-pure-journal | 0 |
| `crate/sim-lib-agent-conduct-recipe-echo` | `crate` | sim-lib-agent-conduct-recipe-echo | 0 |
...
| `crate/sim-lib-capability-pack` | `crate` | sim-lib-capability-pack | 0 |
| `crate/sim-lib-capability-pack-recipe-checked-pack` | `crate` | sim-lib-capability-pack-recipe-checked-pack | 0 |
...
| `crate/sim-lib-compute-femm` | `crate` | sim-lib-compute-femm | 1 |
...
| `crate/sim-lib-continuity-recipe-hostile-replay` | `crate` | sim-lib-continuity-recipe-hostile-replay | 0 |
...
| `crate/sim-lib-hotload` | `crate` | sim-lib-hotload | 1 |
...
| `crate/sim-lib-interference-physics` | `crate` | sim-lib-interference-physics | 0 |
| `crate/sim-lib-interference-solve` | `crate` | sim-lib-interference-solve | 0 |
| `crate/sim-lib-journal` | `crate` | sim-lib-journal | 0 |
...
| `crate/sim-lib-mcp-client` | `crate` | sim-lib-mcp-client | 0 |
| `crate/sim-lib-mcp-http` | `crate` | sim-lib-mcp-http | 0 |
| `crate/sim-lib-mcp-legacy` | `crate` | sim-lib-mcp-legacy | 0 |
| `crate/sim-lib-mcp-stdio` | `crate` | sim-lib-mcp-stdio | 0 |
...
| `crate/sim-lib-model-test` | `crate` | sim-lib-model-test | 1 |
| `crate/sim-lib-model-test-packs` | `crate` | sim-lib-model-test-packs | 0 |
...
| `crate/sim-lib-music-counterpoint` | `crate` | sim-lib-music-counterpoint | 1 |
...
| `crate/sim-lib-music-serial` | `crate` | sim-lib-music-serial | 0 |
...
| `crate/sim-lib-net-http` | `crate` | sim-lib-net-http | 0 |
...
| `crate/sim-lib-numbers-continuation` | `crate` | sim-lib-numbers-continuation | 1 |
| `crate/sim-lib-numbers-core` | `crate` | sim-lib-numbers-core | 0 |
| `crate/sim-lib-numbers-extended` | `crate` | sim-lib-numbers-extended | 1 |
| `crate/sim-lib-numbers-implicit` | `crate` | sim-lib-numbers-implicit | 1 |
| `crate/sim-lib-numbers-interval` | `crate` | sim-lib-numbers-interval | 1 |
| `crate/sim-lib-numbers-method` | `crate` | sim-lib-numbers-method | 1 |
| `crate/sim-lib-numbers-numeric` | `crate` | sim-lib-numbers-numeric | 1 |
| `crate/sim-lib-numbers-optimize` | `crate` | sim-lib-numbers-optimize | 1 |
| `crate/sim-lib-numbers-poly` | `crate` | sim-lib-numbers-poly | 1 |
| `crate/sim-lib-numbers-prelude` | `crate` | sim-lib-numbers-prelude | 0 |
| `crate/sim-lib-numbers-quad` | `crate` | sim-lib-numbers-quad | 1 |
| `crate/sim-lib-numbers-quantity` | `crate` | sim-lib-numbers-quantity | 1 |
| `crate/sim-lib-numbers-rk` | `crate` | sim-lib-numbers-rk | 1 |
| `crate/sim-lib-numbers-root` | `crate` | sim-lib-numbers-root | 1 |
| `crate/sim-lib-numbers-signal` | `crate` | sim-lib-numbers-signal | 1 |
| `crate/sim-lib-numbers-special` | `crate` | sim-lib-numbers-special | 1 |
...
| `crate/sim-lib-numbers-tensor-decomp` | `crate` | sim-lib-numbers-tensor-decomp | 1 |
...
| `crate/sim-lib-oauth-core` | `crate` | sim-lib-oauth-core | 0 |
| `crate/sim-lib-oauth-http` | `crate` | sim-lib-oauth-http | 0 |
| `crate/sim-lib-oauth-jose` | `crate` | sim-lib-oauth-jose | 0 |
| `crate/sim-lib-office-pack` | `crate` | sim-lib-office-pack | 0 |
| `crate/sim-lib-operation-gate` | `crate` | sim-lib-operation-gate | 0 |
| `crate/sim-lib-physics-adapter` | `crate` | sim-lib-physics-adapter | 0 |
| `crate/sim-lib-physics-audit` | `crate` | sim-lib-physics-audit | 0 |
| `crate/sim-lib-physics-core` | `crate` | sim-lib-physics-core | 0 |
| `crate/sim-lib-physics-findings` | `crate` | sim-lib-physics-findings | 0 |
| `crate/sim-lib-physics-influence` | `crate` | sim-lib-physics-influence | 0 |
| `crate/sim-lib-physics-power` | `crate` | sim-lib-physics-power | 0 |
| `crate/sim-lib-physics-proof` | `crate` | sim-lib-physics-proof | 0 |
| `crate/sim-lib-physics-runtime` | `crate` | sim-lib-physics-runtime | 1 |
| `crate/sim-lib-physics-study` | `crate` | sim-lib-physics-study | 0 |
...
| `crate/sim-lib-platform` | `crate` | sim-lib-platform | 1 |
...
| `crate/sim-lib-protected-state` | `crate` | sim-lib-protected-state | 0 |
| `crate/sim-lib-provider-cli` | `crate` | sim-lib-provider-cli | 1 |
| `crate/sim-lib-relation-cli` | `crate` | sim-lib-relation-cli | 1 |
| `crate/sim-lib-repl` | `crate` | sim-lib-repl | 1 |
| `crate/sim-lib-roadmap` | `crate` | sim-lib-roadmap | 1 |
| `crate/sim-lib-roadmap-runner` | `crate` | sim-lib-roadmap-runner | 1 |
| `crate/sim-lib-search` | `crate` | sim-lib-search | 1 |
| `crate/sim-lib-search-core` | `crate` | sim-lib-search-core | 0 |
| `crate/sim-lib-search-http` | `crate` | sim-lib-search-http | 0 |
...
| `crate/sim-lib-stream-fabric` | `crate` | sim-lib-stream-fabric | 0 |
...
| `crate/sim-lib-study` | `crate` | sim-lib-study | 1 |
...
| `crate/sim-lib-view-continuity-phone` | `crate` | sim-lib-view-continuity-phone | 0 |
| `crate/sim-lib-view-daw` | `crate` | sim-lib-view-daw | 0 |
| `crate/sim-lib-view-device` | `crate` | sim-lib-view-device | 0 |
| `crate/sim-lib-view-estate` | `crate` | sim-lib-view-estate | 0 |
...
| `crate/sim-mutual-projection` | `crate` | sim-mutual-projection | 0 |
| `crate/sim-nest` | `crate` | sim-nest | 6 |
| `crate/sim-physics` | `crate` | sim-physics | 0 |
| `crate/sim-platform-amazfit` | `crate` | sim-platform-amazfit | 0 |
| `crate/sim-platform-android` | `crate` | sim-platform-android | 0 |
| `crate/sim-platform-audio` | `crate` | sim-platform-audio | 0 |
| `crate/sim-platform-bootstrap` | `crate` | sim-platform-bootstrap | 0 |
| `crate/sim-platform-browser` | `crate` | sim-platform-browser | 0 |
| `crate/sim-platform-construction` | `crate` | sim-platform-construction | 0 |
| `crate/sim-platform-core` | `crate` | sim-platform-core | 0 |
| `crate/sim-platform-halo` | `crate` | sim-platform-halo | 0 |
| `crate/sim-platform-ios` | `crate` | sim-platform-ios | 0 |
| `crate/sim-platform-linux` | `crate` | sim-platform-linux | 0 |
| `crate/sim-platform-macos` | `crate` | sim-platform-macos | 0 |
| `crate/sim-platform-midi` | `crate` | sim-platform-midi | 0 |
| `crate/sim-platform-model` | `crate` | sim-platform-model | 0 |
| `crate/sim-platform-sqlite` | `crate` | sim-platform-sqlite | 0 |
| `crate/sim-platform-ubuntu-pc` | `crate` | sim-platform-ubuntu-pc | 0 |
| `crate/sim-platform-ubuntu-rpi` | `crate` | sim-platform-ubuntu-rpi | 0 |
| `crate/sim-platform-wasi` | `crate` | sim-platform-wasi | 0 |
| `crate/sim-platform-web-shell` | `crate` | sim-platform-web-shell | 0 |
| `crate/sim-platform-windows` | `crate` | sim-platform-windows | 0 |
| `crate/sim-relation-core` | `crate` | sim-relation-core | 0 |
| `crate/sim-relation-migrate` | `crate` | sim-relation-migrate | 0 |
| `crate/sim-relation-plan` | `crate` | sim-relation-plan | 0 |
| `crate/sim-relation-schema` | `crate` | sim-relation-schema | 0 |
| `crate/sim-relation-shape` | `crate` | sim-relation-shape | 0 |
| `crate/sim-relation-site` | `crate` | sim-relation-site | 1 |
| `crate/sim-roadmap-core` | `crate` | sim-roadmap-core | 0 |
| `crate/sim-roadmap-exec-core` | `crate` | sim-roadmap-exec-core | 0 |
| `crate/sim-roadmap-plan` | `crate` | sim-roadmap-plan | 0 |
| `crate/sim-roadmap-refine` | `crate` | sim-roadmap-refine | 0 |
| `crate/sim-roadmap-refine-recipe-certified-descent` | `crate` | sim-roadmap-refine-recipe-certified-descent | 0 |
| `crate/sim-run` | `crate` | sim-run | 8 |
...
| `crate/sim-source-deck` | `crate` | sim-source-deck | 0 |
| `crate/sim-storage-port` | `crate` | sim-storage-port | 0 |
| `crate/sim-study-core` | `crate` | sim-study-core | 0 |
| `crate/sim-table-core` | `crate` | sim-table-core | 0 |
| `crate/sim-table-mount` | `crate` | sim-table-mount | 1 |
| `crate/sim-table-relation` | `crate` | sim-table-relation | 0 |
| `crate/sim-table-sealed` | `crate` | sim-table-sealed | 0 |
| `crate/sim-test-support` | `crate` | sim-test-support | 0 |
| `crate/sim-text` | `crate` | sim-text | 0 |
| `crate/sim-transport-ports` | `crate` | sim-transport-ports | 0 |
...
| `doc-set/sim-physics/generated` | `doc-set` | sim-physics generated docs | 0 |
| `doc-set/sim-platform/generated` | `doc-set` | sim-platform generated docs | 0 |
...
| `local/sim-agent-net/crate/sim-lib-agent-conduct-core` | `crate` | sim-lib-agent-conduct-core | 0 |
| `local/sim-agent-net/crate/sim-lib-agent-runner-core` | `crate` | sim-lib-agent-runner-core | 0 |
| `local/sim-agent-net/crate/sim-lib-continuity` | `crate` | sim-lib-continuity | 0 |
...
| `local/sim-agent-net/crate/sim-lib-provider` | `crate` | sim-lib-provider | 0 |
...
| `local/sim-numbers/crate/sim-lib-numbers-bigint` | `crate` | sim-lib-numbers-bigint | 1 |
| `local/sim-numbers/crate/sim-lib-numbers-bool` | `crate` | sim-lib-numbers-bool | 1 |
...
| `local/sim-numbers/crate/sim-lib-numbers-exotic` | `crate` | sim-lib-numbers-exotic | 1 |
| `local/sim-numbers/crate/sim-lib-numbers-f64` | `crate` | sim-lib-numbers-f64 | 1 |
| `local/sim-numbers/crate/sim-lib-numbers-fixed` | `crate` | sim-lib-numbers-fixed | 1 |
| `local/sim-numbers/crate/sim-lib-numbers-float` | `crate` | sim-lib-numbers-float | 1 |
| `local/sim-numbers/crate/sim-lib-numbers-func` | `crate` | sim-lib-numbers-func | 1 |
| `local/sim-numbers/crate/sim-lib-numbers-i64` | `crate` | sim-lib-numbers-i64 | 1 |
...
| `local/sim-physics/crate/xtask` | `crate` | xtask | 0 |
| `local/sim-platform/crate/sim-table-fs` | `crate` | sim-table-fs | 0 |
| `local/sim-platform/crate/sim-web-shell` | `crate` | sim-web-shell | 0 |
| `local/sim-platform/crate/xtask` | `crate` | xtask | 0 |
...
| `local/sim-sdk/crate/sim-lib-agent-conduct-core` | `crate` | sim-lib-agent-conduct-core | 0 |
...
| `local/sim-sdk/crate/sim-lib-continuity` | `crate` | sim-lib-continuity | 0 |
...
| `local/sim-sdk/crate/sim-lib-numbers-bigint` | `crate` | sim-lib-numbers-bigint | 0 |
| `local/sim-sdk/crate/sim-lib-numbers-bool` | `crate` | sim-lib-numbers-bool | 0 |
...
| `local/sim-sdk/crate/sim-lib-numbers-exotic` | `crate` | sim-lib-numbers-exotic | 0 |
| `local/sim-sdk/crate/sim-lib-numbers-f64` | `crate` | sim-lib-numbers-f64 | 0 |
| `local/sim-sdk/crate/sim-lib-numbers-fixed` | `crate` | sim-lib-numbers-fixed | 0 |
| `local/sim-sdk/crate/sim-lib-numbers-float` | `crate` | sim-lib-numbers-float | 0 |
| `local/sim-sdk/crate/sim-lib-numbers-func` | `crate` | sim-lib-numbers-func | 0 |
| `local/sim-sdk/crate/sim-lib-numbers-i64` | `crate` | sim-lib-numbers-i64 | 0 |
...
| `local/sim-sdk/crate/sim-lib-provider` | `crate` | sim-lib-provider | 0 |
...
| `local/sim-web/crate/sim-web-shell` | `crate` | sim-web-shell | 3 |
| `local/sim-web/crate/xtask` | `crate` | xtask | 0 |
| `repo/sim-agent-net` | `repo` | sim-agent-net | 49 |
| `repo/sim-audio-daw` | `repo` | sim-audio-daw | 19 |
| `repo/sim-auto` | `repo` | sim-auto | 30 |
| `repo/sim-citizen` | `repo` | sim-citizen | 5 |
| `repo/sim-codecs` | `repo` | sim-codecs | 30 |
...
| `repo/sim-numbers` | `repo` | sim-numbers | 46 |
