...
| `grammar` | `grammar/syntax/javascript` | Bounded ECMAScript 2026 codec |
...
| `specimen` | `codec` | crates/sim-codec-chat/src/tests/openai_responses.rs |
...
| `specimen` | `codec` | crates/sim-codec-compare/src/platform_roundtrip_tests.rs |
| `specimen` | `codec` | crates/sim-codec-feed/src/lib.rs |
| `specimen` | `codec` | crates/sim-codec-index-vault/tests/conformance.rs |
| `specimen` | `codec` | crates/sim-codec-javascript/tests/conformance.rs |
| `specimen` | `codec` | crates/sim-codec-mcp/src/wire_authority.rs |
| `specimen` | `codec` | crates/sim-codec-mcp/src/wire_authority/helpers.rs |
| `specimen` | `codec` | crates/sim-codec-mcp/tests/schema_oracle.rs |
...
| `specimen` | `codec` | crates/sim-codec-robots/src/lib.rs |
| `specimen` | `codec` | crates/sim-codec-search-searxng/src/tests.rs |
| `specimen` | `codec` | crates/sim-codec-sql/src/tests.rs |
| `specimen` | `codec` | crates/sim-codec-typescript/src/tests.rs |
...
| `specimen` | `lisp` | crates/sim-codec-doc/recipes/01-basics/html-extraction/recipe.toml |
| `specimen` | `lisp` | crates/sim-codec-doc/recipes/01-basics/markdown-to-typst/recipe.toml |
| `specimen` | `lisp` | crates/sim-codec-feed/recipes/01-basics/decode-saved-feed/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-ledger/recipes/01-basics/exact-reconciliation/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-agent/recipes/50-conducts/default/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-agent/recipes/50-conducts/effect-free-replay/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-agent/recipes/50-conducts/phased/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-agent/recipes/50-conducts/plan-act-replan/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-agent/recipes/50-conducts/react/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-agent/recipes/50-conducts/router-crew/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-agent/recipes/50-conducts/suspend-resume/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-agent/recipes/50-conducts/third-party-step/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-agent/recipes/50-conducts/verify-retry/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-construction-office/recipes/01-basics/project-chief-weekly-pack/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-construction-project/recipes/01-basics/risk-to-project-chief-decision/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-construction-project/recipes/01-basics/six-week-production-readiness/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-doc-ledger/recipes/01-basics/reconciliation-review/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-doc-web/recipes/01-basics/capture-to-citation/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-doc-web/recipes/01-basics/parallel-reading/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-interference-compute/recipes/01-basics/modeled-fault-containment/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-interference-compute/recipes/01-basics/modeled-resident-study/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-interference-compute/recipes/01-basics/wgpu-absence-refusal/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-interference-compute/recipes/01-basics/wgpu-differential-evidence/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-mcp-client/recipes/01-basics/http-client/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-mcp-client/recipes/01-basics/legacy-fallback/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-mcp-client/recipes/01-basics/mrtr-input/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-mcp-client/recipes/01-basics/stdio-client/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-mcp-client/recipes/01-basics/subscription/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-mcp-http/recipes/01-basics/http-client/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-mcp-http/recipes/01-basics/http-server/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-mcp-legacy/recipes/01-basics/legacy-lifecycle/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-mcp-stdio/recipes/01-basics/legacy-stdio/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-mcp-stdio/recipes/01-basics/modern-stdio/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-model-test-packs/recipes/01-basics/public-conformance/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-model-test/recipes/01-basics/honest-candidate/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-model-test/recipes/02-product/no-network-observatory/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-music-consonance/recipes/01-basics/additive-consonance-completion/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-net-http/recipes/01-basics/bounded-get/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-numbers-continuation/recipes/01-basics/limiting-boundary/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-numbers-extended/recipes/01-basics/convergence/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-numbers-implicit/recipes/01-basics/stiff-decay/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-numbers-interval/recipes/01-basics/sealed-threshold/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-numbers-method/recipes/01-basics/method-evidence/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-numbers-poly/recipes/01-basics/certified-evaluation/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-numbers-quantity/recipes/01-basics/energy-and-torque/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-numbers-root/recipes/01-basics/scalar-root/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-numbers-root/recipes/02-vector/vector-root/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-numbers-special/recipes/01-basics/gamma-tail/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-numbers-tensor-decomp/recipes/01-basics/matrix-functions/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-numbers-tensor-decomp/recipes/01-basics/qr-eigen/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-oauth-core/recipes/01-basics/authorization-code/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-oauth-http/recipes/01-basics/metadata-refresh/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-oauth-jose/recipes/01-basics/verify-token/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-protected-state/recipes/01-basics/exact-binding/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-provider-cli/recipes/01-basics/provider-cli-descriptor/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-provider/recipes/01-basics/open-seat/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-rank/recipes/01-basics/rank-fusion/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-search-core/recipes/01-basics/checked-citation/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-search-http/recipes/01-basics/fixture-site/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-search/recipes/01-fixture/fixture-research/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-lib-web-core/recipes/01-basics/exact-selector/recipe.toml |
| `specimen` | `lisp` | crates/sim-lib-web-layout/recipes/01-basics/workspace-pane/recipe.toml |
| `specimen` | `lisp` | crates/sim-mcp-server/recipes/01-basics/final-stack/recipe.toml |
...
| `specimen` | `lisp` | crates/sim-roadmap-core/recipes/01-basics/bounded-roadmap/recipe.toml |
| `specimen` | `lisp` | crates/sim-roadmap-exec-core/recipes/01-basics/bounded-retry/recipe.toml |
| `specimen` | `lisp` | crates/sim-roadmap-plan/recipes/01-basics/grounded-readiness/recipe.toml |
| `specimen` | `lisp` | crates/sim-run/tests/physics.rs |
...
| `specimen` | `lisp` | crates/sim-source-deck/recipes/01-basics/grounded-evidence/recipe.toml |
...
| `specimen` | `lisp` | recipes/04-expedition-book/decision-book/recipe.toml |
...
| `specimen` | `lisp` | recipes/physics/switched-audit/recipe.toml |
| `specimen` | `lisp` | recipes/reference-project-control/recipe.toml |
| `specimen` | `lisp` | recipes/stewardship/adopt-subtract-composition/recipe.toml |
| `specimen` | `lisp` | recipes/stewardship/calm-flock-care/recipe.toml |
| `specimen` | `lisp` | recipes/stewardship/chosen-media-traces/recipe.toml |
| `specimen` | `lisp` | recipes/stewardship/cited-seasonal-garden/recipe.toml |
| `specimen` | `lisp` | recipes/stewardship/private-observation/recipe.toml |
| `specimen` | `lisp` | recipes/stewardship/taste-led-kitchen/recipe.toml |
...
| `specimen` | `rust` | crates/sim-lib-agent-conduct-core/recipes/01-basics/pure-journal/recipe.toml |
| `specimen` | `rust` | crates/sim-lib-agent-runner-core/recipes/01-basics/output-contract-repair/recipe.toml |
| `specimen` | `rust` | crates/sim-lib-capability-pack/recipes/01-basics/checked-pack/recipe.toml |
| `specimen` | `rust` | crates/sim-lib-continuity/recipes/01-basics/hostile-replay/recipe.toml |
...
| `specimen` | `rust` | crates/sim-lib-interference-core/recipes/01-basics/point-spreading/recipe.toml |
| `specimen` | `rust` | crates/sim-lib-interference-core/recipes/01-basics/travelling-wave/recipe.toml |
| `specimen` | `rust` | crates/sim-lib-interference-solve/recipes/01-basics/animation-projection/recipe.toml |
| `specimen` | `rust` | crates/sim-lib-interference-solve/recipes/01-basics/aperture-refusal/recipe.toml |
...
| `specimen` | `rust` | crates/sim-lib-web-fetch/recipes/01-basics/offline-capture/recipe.toml |
| `specimen` | `rust` | crates/sim-roadmap-refine/recipes/01-basics/certified-descent/recipe.toml |
| `specimen` | `rust` | recipes/00-overview/boundary-event/recipe.toml |
...
| `specimen` | `rust` | recipes/01-power/switched-two-port/recipe.toml |
| `specimen` | `rust` | recipes/02-audit/stored-energy/recipe.toml |
...
| `specimen` | `rust` | recipes/03-proof/certified-refinement/recipe.toml |
| `specimen` | `rust` | recipes/04-influence/refused-selection/recipe.toml |
| `specimen` | `rust` | recipes/05-study/placement-sweep/recipe.toml |
| `specimen` | `rust` | recipes/06-findings/sweep-to-finding/recipe.toml |
| `specimen` | `rust` | recipes/auto-core-citizens/recipe.toml |
| `specimen` | `rust` | recipes/citizen-roundtrip/recipe.toml |
| `specimen` | `rust` | recipes/hotload/conversational-instrument-adoption/recipe.toml |
| `specimen` | `rust` | recipes/hotload/public-generation-loop/recipe.toml |
| `specimen` | `rust` | recipes/javascript/bounded-module/recipe.toml |
| `specimen` | `rust` | recipes/music-algorithm-foundry/recipe.toml |
| `specimen` | `rust` | recipes/python/capability-scoped/recipe.toml |
...
| `specimen` | `shape` | crates/sim-lib-agent/src/agents/model/types.rs |
| `specimen` | `shape` | crates/sim-lib-agent/src/atelier/channel.rs |
| `specimen` | `shape` | crates/sim-lib-agent/src/atelier/instrument_adoption_tests.rs |
| `specimen` | `shape` | crates/sim-lib-agent/src/tests/agent_ai_placement_swap.rs |
| `specimen` | `shape` | crates/sim-lib-agent/src/tests/agent_ai_tools.rs |
| `specimen` | `shape` | crates/sim-lib-agent/src/tests/standard_steps.rs |
...
| `specimen` | `shape` | crates/sim-lib-capability-pack/src/tests.rs |
...
| `specimen` | `shape` | crates/sim-lib-model-test-packs/src/tests.rs |
| `specimen` | `shape` | crates/sim-lib-model-test/src/protocol_tests.rs |
...
| `specimen` | `shape` | crates/sim-lib-numbers-core/src/tests.rs |
| `specimen` | `shape` | crates/sim-lib-numbers-func/src/implementation/domain.rs |
| `specimen` | `shape` | crates/sim-lib-numbers-quantity/src/tests.rs |
...
| `specimen` | `shape` | crates/sim-lib-numbers-signal/src/regular_grid_tests.rs |
...
| `specimen` | `shape` | crates/sim-lib-numbers-tensor-decomp/src/tests.rs |
...
| `specimen` | `shape` | crates/sim-lib-roadmap-runner/src/refiner.rs |
| `specimen` | `shape` | crates/sim-lib-roadmap-runner/src/tests.rs |
| `specimen` | `shape` | crates/sim-lib-roadmap/src/tests.rs |
...
| `specimen` | `shape` | crates/sim-relation-core/tests/domain_and_rows.rs |
...
| `specimen` | `shell` | recipes/02-scenarios/hotload-generation-lifecycle/recipe.toml |
...
| `specimen` | `text` | recipes/stewardship/memo-acceptance/recipe.toml |
| `specimen` | `toml` | recipes/device/revision-4-constellation/recipe.toml |
| `specimen` | `toml` | recipes/stewardship/quiet-cadence/recipe.toml |
...
| `specimen` | `typescript` | crates/sim-lib-lang-typescript/recipes/01-basics/unsupported-type-gap/recipe.toml |
...
| `subject` | `crate/sim-codec-feed` | sim-codec-feed |
| `subject` | `crate/sim-codec-index` | sim-codec-index |
| `subject` | `crate/sim-codec-index-vault` | sim-codec-index-vault |
| `subject` | `crate/sim-codec-javascript` | sim-codec-javascript |
...
| `subject` | `crate/sim-codec-robots` | sim-codec-robots |
| `subject` | `crate/sim-codec-search-searxng` | sim-codec-search-searxng |
| `subject` | `crate/sim-codec-sql` | sim-codec-sql |
| `subject` | `crate/sim-codec-typescript` | sim-codec-typescript |
...
| `subject` | `grammar/feed` | feed grammar |
| `subject` | `grammar/index` | index grammar |
| `subject` | `grammar/index-vault` | index-vault grammar |
| `subject` | `grammar/javascript` | javascript grammar |
...
| `subject` | `grammar/robots` | robots grammar |
| `subject` | `grammar/search-searxng` | search-searxng grammar |
| `subject` | `grammar/sql` | sql grammar |
| `subject` | `grammar/typescript` | typescript grammar |
...
| `subject` | `language/feed` | feed |
| `subject` | `language/index` | index |
| `subject` | `language/index-vault` | index-vault |
| `subject` | `language/javascript` | javascript |
...
| `subject` | `language/robots` | robots |
| `subject` | `language/search-searxng` | search-searxng |
| `subject` | `language/sql` | sql |
| `subject` | `language/typescript` | typescript |
...
| `subject` | `runtime-lib/sim-codec-javascript/javascript-codec-lib` | javascript-codec-lib |
